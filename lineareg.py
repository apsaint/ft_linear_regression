...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2020/01/06 12:21:02 by apsaint-          #+#    #+#              #
#    Updated: 2020/01/06 12:21:02 by apsaint-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
#!/usr/bin/python3
...
def main():
    ...
    p = estimatePrice_calc(kms, theta0, theta1)
    print(f"Le prix estimé avec le kilometrage {kms} est de : {p} €")
